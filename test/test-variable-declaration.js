...
const testCases = [
    ...
    {
        name: 'Global CONST values remain visible inside SUB scopes',
        code: `
            CONST LIMIT = 10
    ...
    {
        name: 'Typed SUB parameters keep declared bindings at runtime',
        code: `
            SUB ShowPair (value AS INTEGER, caption AS STRING)
                PRINT value
                PRINT caption
            END SUB
    ...
    {
        name: 'Typed FUNCTION signatures honor explicit STRING return types',
        code: `
    ...
    {
        name: 'SUB parameters default to BYREF and update caller variables',
        code: `
    ...
    {
        name: 'FUNCTION parameters default to BYREF through expression-call paths',
        code: `
            FUNCTION IncrementAndReturn (value AS INTEGER)
                value = value + 1
                IncrementAndReturn = value
            END FUNCTION

            count = 1
            PRINT IncrementAndReturn(count)
            PRINT count
        `,
        shouldWork: true,
        expectedOutput: ['2', '2']
    ...
    {
        name: 'BYREF parameters can update TYPE member-chain arguments',
        code: `
            TYPE CounterBox
                Value AS INTEGER
            END TYPE
            ...
            DIM sample AS CounterBox
            sample.Value = 1
            CALL Increment(sample.Value)
            PRINT sample.Value
        `,
        shouldWork: true,
        expectedOutput: ['2']
    ...
    {
        name: 'BYVAL parameters isolate scalar caller variables',
        code: `
    ...
    {
        name: 'BYVAL parameters copy user-defined TYPE arguments',
        code: `
            TYPE CounterBox
                Value AS INTEGER
            END TYPE

            SUB ResetBox (BYVAL box AS CounterBox)
                box.Value = 9
            END SUB

            DIM sample AS CounterBox
            sample.Value = 1
            CALL ResetBox(sample)
            PRINT sample.Value
        `,
        shouldWork: true,
        expectedOutput: ['1']
    ...
    {
        name: 'BYREF parameters stay connected inside structured FOR loops',
        code: `
            SUB CountToThree (value AS INTEGER)
                FOR value = 1 TO 3
                NEXT value
            END SUB

            count = 0
            CALL CountToThree(count)
            PRINT count
        `,
        shouldWork: true,
        expectedOutput: ['4']
    ...
    {
        name: 'Forward user-defined TYPE declarations initialize correctly',
        code: `
            DIM sample AS FutureBox
    ...
    {
        name: 'TYPE names can reuse built-in function keywords',
        code: `
            TYPE Point
                Value AS INTEGER
            END TYPE
