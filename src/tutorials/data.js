// QBasic lesson data for the Tutorial system
// Each lesson consists of: id, title, objective, description, template, matchRegex, hint
...
module.exports = [
  {
    ...
    description:
      "The PRINT command is used to display text. Strings must be enclosed in double quotes.",
    template: 'CLS\nPRINT "Hello World"',
  ...
  },
  {
    ...
    description:
      "Variables store data. In QBasic, you can assign values directly.",
    template: "CLS\nscore = 100\nPRINT score",
    matchRegex: /100/,
