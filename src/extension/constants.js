...
const CONFIG = Object.freeze({
  ...
  INTERNAL_WASM_ACCELERATOR: 'internalWasmAccelerator',
  ...
  WASM_ACCELERATOR_AUTO: 'auto',
  WASM_ACCELERATOR_ON: 'on',
  WASM_ACCELERATOR_OFF: 'off',
  LANGUAGE_ID: 'qbasic',
...
const COMMANDS = Object.freeze({
  ...
  SELECT_INTERNAL_WASM_ACCELERATOR: 'qbasic-nexus.selectInternalWasmAccelerator',
